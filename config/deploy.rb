set :application, "learnror"
set :repository,  "git@github.com:vkurennov/learnror.git"
...
role :web, "188.226.201.212"                          # Your HTTP server, Apache/etc
role :app, "188.226.201.212"                          # This may be the same as your `Web` server
role :db,  "188.226.201.212", :primary => true # This is where Rails migrations will run
