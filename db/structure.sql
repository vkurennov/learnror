...
CREATE TABLE "permissions" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar(255), "action" varchar(255), "subject" varchar(255), "subject_id" integer, "created_at" datetime, "updated_at" datetime);
...
CREATE TABLE "user_permissions" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "user_id" integer, "permission_id" integer, "created_at" datetime, "updated_at" datetime);
...
CREATE INDEX "index_user_permissions_on_permission_id" ON "user_permissions" ("permission_id");
CREATE INDEX "index_user_permissions_on_user_id" ON "user_permissions" ("user_id");
